...
uint32_t input32[1] = { 0 };
uint32_t result32[1] = { 0 };

uint32_t input64[2] = { 0 };
uint32_t result64[2] = { 0 };
...
uint32_t input4096[128] = { 0 };
uint32_t result4096[128] = { 0 };
...
int main(int argc, char const *argv[])
{
  ...
  randomizer_init();
    ...
    autoTest(input32   ,result32  ,numberOfTests, 1 );
    autoTest(input64   ,result64  ,numberOfTests, 2 );
